...
tagList = ["title", "h1", "h2", "h3", "h4", "h5", "h6", "a", "span", "label", "header", "p", "modal", "dialog", "button", "svg", "form"] 
...
translatedFile = input("Input file name to load translation from (Excel, default is input.xlsx):" )
if len(translatedFile)<1:
    translatedFile = "input.xlsx"
...
outputJson = {"origin": origin, "spanish":translated}
